...
<head>
    ...
    <title>Actualizar Servicio - Sistema PetCare</title>
    <style>
        :root {
        ...
        * {
        ...
        /* Servicio Info */
        .servicio-info {
            background: linear-gradient(135deg, rgba(171, 203, 213, 0.1) 0%, rgba(171, 203, 213, 0.05) 100%);
            padding: 25px;
            border-radius: var(--radius);
            margin-bottom: 30px;
                    ...
                    <div class="form-body">
                        <% if (servicio != null) { %>
                            ...
                            <div class="servicio-info">
                                <h4>📋 Información Actual del Servicio</h4>
                                <p><strong>ID:</strong> <%= servicio.getIdServicio() %> | 
                                   <strong>Código:</strong> <%= servicio.getCodigo() %> | 
                                   <strong>Nombre:</strong> <%= servicio.getNombre() %></p>
                            </div>
                            ...
                            <form action="ServicioControlador" method="POST" id="servicioForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="codigo" name="codigo" class="form-control" required 
                                           value="<%= servicio.getCodigo() != null ? servicio.getCodigo() : "" %>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nombre" name="nombre" class="form-control" required 
                                           ...
                                           placeholder="Ej: Baño Completo para Perros">
                                </div>

                                <div class="form-group">
                                    <label for="descripcion">Descripción</label>
                                    <textarea id="descripcion" name="descripcion" class="form-control"
                                              placeholder="Descripción detallada del servicio..."><%= servicio.getDescripcion() != null ? servicio.getDescripcion() : "" %></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="duracionEstimadaMin">Duración Estimada (minutos)</label>
                                    <input type="number" id="duracionEstimadaMin" name="duracionEstimadaMin" class="form-control"
                                           value="<%= servicio.getDuracionEstimadaMin() %>" min="1" max="480"
                                           placeholder="Ej: 60">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="precioBase" name="precioBase" class="form-control" step="0.01" required 
                                           value="<%= String.format("%.2f", servicio.getPrecioBase()) %>" min="0"
                                    ...
                                    <select id="categoria" name="categoria" class="form-control" required>
                                        ...
                                        <% if (categorias != null) { 
                                            for (String categoria : categorias) { 
                                                boolean selected = categoria.equals(servicio.getCategoria());
                                        %>
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-success pulse">💾 Guardar Cambios</button>
                                    <a href="ServicioControlador" class="btn btn-secondary">❌ Cancelar</a>
                                    <a href="ServicioControlador?accion=formularioInsertar" class="btn btn-warning">➕ Nuevo Servicio</a>
                                </div>
                            </form>
                        <% } else { %>
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    if (parseFloat(precio) < 0) {
                        e.preventDefault();
                        showMessage('El precio no puede ser negativo', 'error');
                        return false;
                    }
