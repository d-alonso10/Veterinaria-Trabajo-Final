...
<head>
    ...
    <title>Servicios por Categoría - Sistema PetCare</title>
    <style>
        :root {
...
<body>
            ...
            <div class="header">
                <div class="header-top">
                    <div class="welcome">
                        ...
                        <p>Explora y gestiona servicios organizados por categorías</p>
                    </div>
                    <div class="header-actions">
                        <a href="ServicioControlador?accion=formularioInsertar" class="btn btn-success">➕ Nuevo Servicio</a>
                        <a href="ServicioControlador" class="btn btn-info">📋 Todos los Servicios</a>
                    </div>
                </div>
            </div>
            ...
            <div class="main-content">
                ...
                <% if (categoria != null) { %>
                    <div class="categoria-header">
                        ...
                        <p><%= totalServicios != null ? totalServicios : 0 %> servicios en esta categoría</p>
                    </div>
                <% } %>
                ...
                <div class="filter-container">
                    ...
                    <div class="filter-options">
                        ...
                        %>
                            <a href="ServicioControlador?accion=porCategoria&categoria=<%= cat %>" 
                               class="btn btn-info btn-small">
                               <%= cat.toUpperCase() %>
                            </a>
                        <% } } } %>
                        <a href="ServicioControlador" class="btn btn-primary btn-small">
                ...
                <div class="table-container">
                    ...
                    <% } else { %>
                        <div class="empty-state">
                            <h3>📭 No hay servicios en esta categoría</h3>
                            <p>No se encontraron servicios en la categoría '<%= categoria %>'</p>
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a href="ServicioControlador" class="btn btn-primary">📋 Volver a Todos los Servicios</a>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Efecto hover para badges de categoría
            const categoriaBadges = document.querySelectorAll('.categoria-badge');
            categoriaBadges.forEach(badge => {
